...
class BookFormatFactory:
    ...
    def get_format(self, book_format: str) -> Format:
        if not self._formats.get(book_format):
            self._formats[book_format] = Format(book_format)
        return self._formats[book_format]
